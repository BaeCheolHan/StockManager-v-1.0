...
public class PersonalSettingController {
	...
	public PersonalBankAccountSettingResponse findByBankAccountId(@PathVariable Long bankAccountId) {
	...
	public BaseResponse savePersonalSetting(@PathVariable Long bankAccountId, @RequestBody PersonalBankAccountSettingDto personalBankAccountSettingSaveRequest) {
